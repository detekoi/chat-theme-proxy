...
gcloud run deploy theme-proxy \
  ...
  --set-secrets GEMINI_API_KEY=gemini-api-key:latest,RUNWARE_API_KEY=RUNWARE_API_KEY:latest,WEB_FONTS_API_KEY=WEB_FONTS_API_KEY:latest,TWITCH_CLIENT_ID=TWITCH_CLIENT_ID:latest || {
